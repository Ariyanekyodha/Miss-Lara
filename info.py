...
SHORTLINK_API = environ.get('SHORTLINK_API', 'd872a57b2b4597935ac5ea5d61eff940e258be9a')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Aj_Support_Group')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"⚡<b>File uploaded by [Aj MovieBook™](https://t.me/Aj_MovieBook)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Aj MovieBook™](https://t.me/Aj_MovieBook)</b> ↭  🔥")
...
URL = "https://misslara-moviebook.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://misslara-moviebook.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://misslara-moviebook.koyeb.app/".format(FQDN)
else:
    URL = "https://misslara-moviebook.koyeb.app/".format(FQDN)
